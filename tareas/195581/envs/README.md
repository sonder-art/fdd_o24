...
Para descargar Conda se hace con el siguiente comando: `bash Miniconda3-latest-Linux-x86_64.sh`
#### Activar conda env
`conda init `
...
## Docker
[https://hub.docker.com/r/albertomarquez794/albertoe](url)  
## Github
